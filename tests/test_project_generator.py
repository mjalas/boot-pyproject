...
import yaml
import os
from tests.test_helpers import test_configuration
...
class TestProjectGenerator(TestCase):
    ...
    def setUp(self):
        ...
        self.folder_structures = [
            "pyprojectgen",
            "pyprojectgen/pyprojectgen",
            "pyprojectgen/tests",
        ]

    def tearDown(self):
        self.__remove_file(self.file_path)
        self.__remove_file(self.tmp_path + "pyprojectgen/pyprojectgen/__init__.py")
        ...
        self.__remove_file(self.tmp_path + "pyprojectgen/pyprojectgen/metadata.py")
    ...
    def test_generate_project(self):
        ...
        self.assertTrue(os.path.exists(self.tmp_path + "pyprojectgen/pyprojectgen/__init__.py"), "")
        ...
        self.assertTrue(os.path.exists(self.tmp_path + "pyprojectgen/pyprojectgen/metadata.py"))
